########################################################################################################################
# File name: interface_ve_ipv6_router_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ve/ipv6/router/ospf',
]
...
class InterfaceVeIpv6RouterOspfClient(AbstractResourceClient):
	...
	def getInterfaceVeIpv6RouterOspf(self):
		"""
	...
	def putInterfaceVeIpv6RouterOspf(self, ospf):
		"""
	...
	def deleteInterfaceVeIpv6RouterOspf(self):
		"""
...
class AllInterfaceVeIpv6RouterOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceVeIpv6RouterOspf(self, ospf):
		"""
	...
	def getAllInterfaceVeIpv6RouterOspfs(self):
		"""
