########################################################################################################################
# File name: interface_loopback_ip_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/loopback/ip/ospf',
]
...
class InterfaceLoopbackIpOspfClient(AbstractResourceClient):
	...
	def getInterfaceLoopbackIpOspf(self):
		"""
	...
	def putInterfaceLoopbackIpOspf(self, ospf):
		"""
	...
	def deleteInterfaceLoopbackIpOspf(self):
		"""
...
class AllInterfaceLoopbackIpOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceLoopbackIpOspf(self, ospf):
		"""
	...
	def getAllInterfaceLoopbackIpOspfs(self):
		"""
