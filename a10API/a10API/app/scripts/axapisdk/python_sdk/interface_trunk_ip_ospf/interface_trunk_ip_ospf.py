########################################################################################################################
# File name: interface_trunk_ip_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/trunk/ip/ospf',
]
...
class InterfaceTrunkIpOspfClient(AbstractResourceClient):
	...
	def getInterfaceTrunkIpOspf(self):
		"""
	...
	def putInterfaceTrunkIpOspf(self, ospf):
		"""
	...
	def deleteInterfaceTrunkIpOspf(self):
		"""
...
class AllInterfaceTrunkIpOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceTrunkIpOspf(self, ospf):
		"""
	...
	def getAllInterfaceTrunkIpOspfs(self):
		"""
