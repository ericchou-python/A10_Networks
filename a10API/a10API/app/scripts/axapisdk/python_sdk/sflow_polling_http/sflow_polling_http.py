########################################################################################################################
# File name: sflow_polling_http.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/sflow/polling/http',
]
...
class SflowPollingHttpClient(AbstractResourceClient):
	...
	def putSflowPollingHttp(self, http):
		"""
	...
	def deleteSflowPollingHttp(self):
		"""
...
class AllSflowPollingHttpsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitSflowPollingHttp(self, http):
		"""
	...
	def getAllSflowPollingHttps(self):
		"""
