########################################################################################################################
# File name: router_ipv6_ospf_redistribute.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/router/ipv6/ospf/redistribute',
]
...
class RouterIpv6OspfRedistributeClient(AbstractResourceClient):
	...
	def getRouterIpv6OspfRedistribute(self):
		"""
	...
	def putRouterIpv6OspfRedistribute(self, redistribute):
		"""
	...
	def deleteRouterIpv6OspfRedistribute(self):
		"""
...
class AllRouterIpv6OspfRedistributesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitRouterIpv6OspfRedistribute(self, redistribute):
		"""
	...
	def getAllRouterIpv6OspfRedistributes(self):
		"""
