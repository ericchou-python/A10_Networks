########################################################################################################################
# File name: interface_trunk_ipv6_router_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/trunk/ipv6/router/ospf',
]
...
class InterfaceTrunkIpv6RouterOspfClient(AbstractResourceClient):
	...
	def getInterfaceTrunkIpv6RouterOspf(self):
		"""
	...
	def putInterfaceTrunkIpv6RouterOspf(self, ospf):
		"""
	...
	def deleteInterfaceTrunkIpv6RouterOspf(self):
		"""
...
class AllInterfaceTrunkIpv6RouterOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceTrunkIpv6RouterOspf(self, ospf):
		"""
	...
	def getAllInterfaceTrunkIpv6RouterOspfs(self):
		"""
