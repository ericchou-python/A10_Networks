########################################################################################################################
# File name: disable_management_service_snmp.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/disable-management/service/snmp',
]
...
def deserialize_Snmp_json(obj):
	...
	result = Snmp(management=management)
	return result
...
class DisablemanagementServiceSnmpClient(AbstractResourceClient):
	...
	def getDisablemanagementServiceSnmp(self):
		"""
	...
	def putDisablemanagementServiceSnmp(self, snmp):
		"""
	...
	def deleteDisablemanagementServiceSnmp(self):
		"""
...
class AllDisablemanagementServiceSnmpsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDisablemanagementServiceSnmp(self, snmp):
		"""
	...
	def getAllDisablemanagementServiceSnmps(self):
		"""
