########################################################################################################################
# File name: interface_ethernet_ipv6_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ethernet/ipv6/ospf',
]
...
class InterfaceEthernetIpv6OspfClient(AbstractResourceClient):
	...
	def getInterfaceEthernetIpv6Ospf(self):
		"""
	...
	def putInterfaceEthernetIpv6Ospf(self, ospf):
		"""
	...
	def deleteInterfaceEthernetIpv6Ospf(self):
		"""
...
class AllInterfaceEthernetIpv6OspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceEthernetIpv6Ospf(self, ospf):
		"""
	...
	def getAllInterfaceEthernetIpv6Ospfs(self):
		"""
