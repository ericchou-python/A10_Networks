########################################################################################################################
# File name: ddos_src_geo_location_app_type.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/ddos/src/geo-location/app-type',
]
...
def deserialize_App_type__template_json(obj):
	...
	dns = data.get('dns')
	http = data.get('http')
	result = App_type__template(dns=dns, http=http)
	return result
...
class DdosSrcGeolocationApptypeClient(AbstractResourceClient):
	...
	def getDdosSrcGeolocationApptype(self, app_type_protocol):
		"""
	...
	def putDdosSrcGeolocationApptype(self, app_type_protocol, app_type):
		"""
	...
	def deleteDdosSrcGeolocationApptype(self, app_type_protocol):
		"""
...
class AllDdosSrcGeolocationApptypesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDdosSrcGeolocationApptype(self, app_type):
		"""
	...
	def getAllDdosSrcGeolocationApptypes(self):
		"""
