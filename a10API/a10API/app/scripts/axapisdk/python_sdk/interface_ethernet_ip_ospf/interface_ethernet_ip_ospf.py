########################################################################################################################
# File name: interface_ethernet_ip_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ethernet/ip/ospf',
]
...
class InterfaceEthernetIpOspfClient(AbstractResourceClient):
	...
	def getInterfaceEthernetIpOspf(self):
		"""
	...
	def putInterfaceEthernetIpOspf(self, ospf):
		"""
	...
	def deleteInterfaceEthernetIpOspf(self):
		"""
...
class AllInterfaceEthernetIpOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceEthernetIpOspf(self, ospf):
		"""
	...
	def getAllInterfaceEthernetIpOspfs(self):
		"""
