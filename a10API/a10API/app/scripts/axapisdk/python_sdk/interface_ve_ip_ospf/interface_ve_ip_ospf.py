########################################################################################################################
# File name: interface_ve_ip_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ve/ip/ospf',
]
...
class InterfaceVeIpOspfClient(AbstractResourceClient):
	...
	def putInterfaceVeIpOspf(self, ospf):
		"""
	...
	def deleteInterfaceVeIpOspf(self):
		"""
...
class AllInterfaceVeIpOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceVeIpOspf(self, ospf):
		"""
	...
	def getAllInterfaceVeIpOspfs(self):
		"""
