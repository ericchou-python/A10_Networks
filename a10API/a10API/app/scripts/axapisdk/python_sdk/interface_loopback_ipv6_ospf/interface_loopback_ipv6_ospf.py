########################################################################################################################
# File name: interface_loopback_ipv6_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/loopback/ipv6/ospf',
]
...
class InterfaceLoopbackIpv6OspfClient(AbstractResourceClient):
	...
	def getInterfaceLoopbackIpv6Ospf(self):
		"""
	...
	def putInterfaceLoopbackIpv6Ospf(self, ospf):
		"""
	...
	def deleteInterfaceLoopbackIpv6Ospf(self):
		"""
...
class AllInterfaceLoopbackIpv6OspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceLoopbackIpv6Ospf(self, ospf):
		"""
	...
	def getAllInterfaceLoopbackIpv6Ospfs(self):
		"""
