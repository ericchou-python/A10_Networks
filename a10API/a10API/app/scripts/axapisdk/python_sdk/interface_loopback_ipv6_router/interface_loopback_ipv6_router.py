########################################################################################################################
# File name: interface_loopback_ipv6_router.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/loopback/ipv6/router',
]
...
class InterfaceLoopbackIpv6RouterClient(AbstractResourceClient):
	...
	def getInterfaceLoopbackIpv6Router(self):
		"""
	...
	def putInterfaceLoopbackIpv6Router(self, router):
		"""
	...
	def deleteInterfaceLoopbackIpv6Router(self):
		"""
...
class AllInterfaceLoopbackIpv6RoutersClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceLoopbackIpv6Router(self, router):
		"""
	...
	def getAllInterfaceLoopbackIpv6Routers(self):
		"""
