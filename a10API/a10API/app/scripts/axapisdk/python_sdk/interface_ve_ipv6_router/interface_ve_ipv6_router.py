########################################################################################################################
# File name: interface_ve_ipv6_router.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ve/ipv6/router',
]
...
class InterfaceVeIpv6RouterClient(AbstractResourceClient):
	...
	def getInterfaceVeIpv6Router(self):
		"""
	...
	def putInterfaceVeIpv6Router(self, router):
		"""
	...
	def deleteInterfaceVeIpv6Router(self):
		"""
...
class AllInterfaceVeIpv6RoutersClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceVeIpv6Router(self, router):
		"""
	...
	def getAllInterfaceVeIpv6Routers(self):
		"""
