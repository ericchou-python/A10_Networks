...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/backup/system',
]
...
def deserialize_System_json(obj):
	...
	result = System(use_mgmt_port=use_mgmt_port, remote_file=remote_file, file_name=file_name)
	return result
...
class BackupSystemClient(AbstractResourceClient):
	...
	def putBackupSystem(self, system):
		"""
...
class AllBackupSystemsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitBackupSystem(self, system):
		"""
