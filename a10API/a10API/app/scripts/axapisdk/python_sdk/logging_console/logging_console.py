...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/logging/console',
]
...
def deserialize_Console_json(obj):
	...
	result = Console(console_levelnum=console_levelnum, console_levelname=console_levelname)
	return result
...
class LoggingConsoleClient(AbstractResourceClient):
	...
	def putLoggingConsole(self, console):
		"""
...
class AllLoggingConsolesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitLoggingConsole(self, console):
		"""
	...
	def getAllLoggingConsoles(self):
		"""
