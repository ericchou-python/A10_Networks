########################################################################################################################
# File name: ddos_dst_default_ip_proto.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/ddos/dst/default/ip-proto',
]
...
class DdosDstDefaultIpprotoClient(AbstractResourceClient):
	...
	def getDdosDstDefaultIpproto(self, ip_proto_port_num):
		"""
	...
	def putDdosDstDefaultIpproto(self, ip_proto_port_num, ip_proto):
		"""
	...
	def deleteDdosDstDefaultIpproto(self, ip_proto_port_num):
		"""
...
class AllDdosDstDefaultIpprotosClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDdosDstDefaultIpproto(self, ip_proto):
		"""
	...
	def getAllDdosDstDefaultIpprotos(self):
		"""
