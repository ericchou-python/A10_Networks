########################################################################################################################
# File name: ddos_src_geo_location_l4_type.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/ddos/src/geo-location/l4-type',
]
...
def deserialize_L4_type_json(obj):
	...
	result = L4_type(protocol=protocol, deny=deny, glid=glid, template=template)
	return result
...
class DdosSrcGeolocationL4typeClient(AbstractResourceClient):
	...
	def getDdosSrcGeolocationL4type(self, l4_type_protocol):
		"""
	...
	def putDdosSrcGeolocationL4type(self, l4_type_protocol, l4_type):
		"""
	...
	def deleteDdosSrcGeolocationL4type(self, l4_type_protocol):
		"""
...
class AllDdosSrcGeolocationL4typesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDdosSrcGeolocationL4type(self, l4_type):
		"""
	...
	def getAllDdosSrcGeolocationL4types(self):
		"""
