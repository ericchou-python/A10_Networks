########################################################################################################################
# File name: interface_loopback_ipv6_router_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/loopback/ipv6/router/ospf',
]
...
class InterfaceLoopbackIpv6RouterOspfClient(AbstractResourceClient):
	...
	def getInterfaceLoopbackIpv6RouterOspf(self):
		"""
	...
	def putInterfaceLoopbackIpv6RouterOspf(self, ospf):
		"""
	...
	def deleteInterfaceLoopbackIpv6RouterOspf(self):
		"""
...
class AllInterfaceLoopbackIpv6RouterOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceLoopbackIpv6RouterOspf(self, ospf):
		"""
	...
	def getAllInterfaceLoopbackIpv6RouterOspfs(self):
		"""
