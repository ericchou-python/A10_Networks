########################################################################################################################
# File name: router_bgp_address_family_ipv6_redistribute.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/router/bgp/address-family/ipv6/redistribute',
]
...
class RouterBgpAddressfamilyIpv6RedistributeClient(AbstractResourceClient):
	...
	def getRouterBgpAddressfamilyIpv6Redistribute(self):
		"""
	...
	def putRouterBgpAddressfamilyIpv6Redistribute(self, redistribute):
		"""
	...
	def deleteRouterBgpAddressfamilyIpv6Redistribute(self):
		"""
...
class AllRouterBgpAddressfamilyIpv6RedistributesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitRouterBgpAddressfamilyIpv6Redistribute(self, redistribute):
		"""
	...
	def getAllRouterBgpAddressfamilyIpv6Redistributes(self):
		"""
