########################################################################################################################
# File name: interface_trunk_ipv6_router.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/trunk/ipv6/router',
]
...
class InterfaceTrunkIpv6RouterClient(AbstractResourceClient):
	...
	def getInterfaceTrunkIpv6Router(self):
		"""
	...
	def putInterfaceTrunkIpv6Router(self, router):
		"""
	...
	def deleteInterfaceTrunkIpv6Router(self):
		"""
...
class AllInterfaceTrunkIpv6RoutersClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceTrunkIpv6Router(self, router):
		"""
	...
	def getAllInterfaceTrunkIpv6Routers(self):
		"""
