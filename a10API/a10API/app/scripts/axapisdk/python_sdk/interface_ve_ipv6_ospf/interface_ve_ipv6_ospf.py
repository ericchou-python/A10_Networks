########################################################################################################################
# File name: interface_ve_ipv6_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ve/ipv6/ospf',
]
...
class InterfaceVeIpv6OspfClient(AbstractResourceClient):
	...
	def getInterfaceVeIpv6Ospf(self):
		"""
	...
	def putInterfaceVeIpv6Ospf(self, ospf):
		"""
	...
	def deleteInterfaceVeIpv6Ospf(self):
		"""
...
class AllInterfaceVeIpv6OspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceVeIpv6Ospf(self, ospf):
		"""
	...
	def getAllInterfaceVeIpv6Ospfs(self):
		"""
