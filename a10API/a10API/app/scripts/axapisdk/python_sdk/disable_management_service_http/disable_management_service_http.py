########################################################################################################################
# File name: disable_management_service_http.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/disable-management/service/http',
]
...
def deserialize_Http_json(obj):
	...
	result = Http(management=management)
	return result
...
class DisablemanagementServiceHttpClient(AbstractResourceClient):
	...
	def getDisablemanagementServiceHttp(self):
		"""
	...
	def putDisablemanagementServiceHttp(self, http):
		"""
	...
	def deleteDisablemanagementServiceHttp(self):
		"""
...
class AllDisablemanagementServiceHttpsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDisablemanagementServiceHttp(self, http):
		"""
	...
	def getAllDisablemanagementServiceHttps(self):
		"""
