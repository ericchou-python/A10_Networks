########################################################################################################################
# File name: router_isis_address_family_ipv6_redistribute.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/router/isis/address-family/ipv6/redistribute',
]
...
class RouterIsisAddressfamilyIpv6RedistributeClient(AbstractResourceClient):
	...
	def getRouterIsisAddressfamilyIpv6Redistribute(self):
		"""
	...
	def putRouterIsisAddressfamilyIpv6Redistribute(self, redistribute):
		"""
	...
	def deleteRouterIsisAddressfamilyIpv6Redistribute(self):
		"""
...
class AllRouterIsisAddressfamilyIpv6RedistributesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitRouterIsisAddressfamilyIpv6Redistribute(self, redistribute):
		"""
	...
	def getAllRouterIsisAddressfamilyIpv6Redistributes(self):
		"""
