########################################################################################################################
# File name: ddos_src_default_app_type.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/ddos/src/default/app-type',
]
...
def deserialize_App_type__template_json(obj):
	...
	result = App_type__template(dns=dns, http=http, ssl_l4=ssl_l4)
	return result
...
class DdosSrcDefaultApptypeClient(AbstractResourceClient):
	...
	def getDdosSrcDefaultApptype(self, app_type_protocol):
		"""
	...
	def putDdosSrcDefaultApptype(self, app_type_protocol, app_type):
		"""
	...
	def deleteDdosSrcDefaultApptype(self, app_type_protocol):
		"""
...
class AllDdosSrcDefaultApptypesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDdosSrcDefaultApptype(self, app_type):
		"""
	...
	def getAllDdosSrcDefaultApptypes(self):
		"""
