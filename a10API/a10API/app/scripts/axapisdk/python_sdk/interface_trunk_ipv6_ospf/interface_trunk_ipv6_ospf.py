########################################################################################################################
# File name: interface_trunk_ipv6_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/trunk/ipv6/ospf',
]
...
class InterfaceTrunkIpv6OspfClient(AbstractResourceClient):
	...
	def getInterfaceTrunkIpv6Ospf(self):
		"""
	...
	def putInterfaceTrunkIpv6Ospf(self, ospf):
		"""
	...
	def deleteInterfaceTrunkIpv6Ospf(self):
		"""
...
class AllInterfaceTrunkIpv6OspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceTrunkIpv6Ospf(self, ospf):
		"""
	...
	def getAllInterfaceTrunkIpv6Ospfs(self):
		"""
