########################################################################################################################
# File name: interface_ethernet_ipv6_router_ospf.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/interface/ethernet/ipv6/router/ospf',
]
...
class InterfaceEthernetIpv6RouterOspfClient(AbstractResourceClient):
	...
	def getInterfaceEthernetIpv6RouterOspf(self):
		"""
	...
	def putInterfaceEthernetIpv6RouterOspf(self, ospf):
		"""
	...
	def deleteInterfaceEthernetIpv6RouterOspf(self):
		"""
...
class AllInterfaceEthernetIpv6RouterOspfsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitInterfaceEthernetIpv6RouterOspf(self, ospf):
		"""
	...
	def getAllInterfaceEthernetIpv6RouterOspfs(self):
		"""
