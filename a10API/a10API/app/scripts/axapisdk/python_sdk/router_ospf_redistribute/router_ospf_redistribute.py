########################################################################################################################
# File name: router_ospf_redistribute.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/router/ospf/redistribute',
]
...
class RouterOspfRedistributeClient(AbstractResourceClient):
	...
	def getRouterOspfRedistribute(self):
		"""
	...
	def putRouterOspfRedistribute(self, redistribute):
		"""
	...
	def deleteRouterOspfRedistribute(self):
		"""
...
class AllRouterOspfRedistributesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitRouterOspfRedistribute(self, redistribute):
		"""
	...
	def getAllRouterOspfRedistributes(self):
		"""
