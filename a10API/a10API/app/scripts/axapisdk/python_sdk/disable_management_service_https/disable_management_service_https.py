########################################################################################################################
# File name: disable_management_service_https.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/disable-management/service/https',
]
...
def deserialize_Https_json(obj):
	...
	result = Https(management=management)
	return result
...
class DisablemanagementServiceHttpsClient(AbstractResourceClient):
	...
	def getDisablemanagementServiceHttps(self):
		"""
	...
	def putDisablemanagementServiceHttps(self, https):
		"""
	...
	def deleteDisablemanagementServiceHttps(self):
		"""
...
class AllDisablemanagementServiceHttpssClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDisablemanagementServiceHttps(self, https):
		"""
	...
	def getAllDisablemanagementServiceHttpss(self):
		"""
