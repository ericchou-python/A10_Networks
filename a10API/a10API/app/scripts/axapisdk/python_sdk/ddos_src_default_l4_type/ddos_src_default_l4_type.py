########################################################################################################################
# File name: ddos_src_default_l4_type.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/ddos/src/default/l4-type',
]
...
class DdosSrcDefaultL4typeClient(AbstractResourceClient):
	...
	def getDdosSrcDefaultL4type(self, l4_type_protocol):
		"""
	...
	def putDdosSrcDefaultL4type(self, l4_type_protocol, l4_type):
		"""
	...
	def deleteDdosSrcDefaultL4type(self, l4_type_protocol):
		"""
...
class AllDdosSrcDefaultL4typesClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitDdosSrcDefaultL4type(self, l4_type):
		"""
	...
	def getAllDdosSrcDefaultL4types(self):
		"""
