########################################################################################################################
# File name: sflow_polling_ethernet.py
...
BASE_URL = [
	'https://axapi.a10networks.com/axapi/v3/sflow/polling/ethernet',
]
...
def deserialize_Ethernet_json(obj):
	...
	result = Ethernet(start=start, interval=interval)
	return result
...
class SflowPollingEthernetClient(AbstractResourceClient):
	...
	def getSflowPollingEthernet(self, ethernet_start):
		"""
	...
	def putSflowPollingEthernet(self, ethernet_start, ethernet):
		"""
	...
	def deleteSflowPollingEthernet(self, ethernet_start):
		"""
...
class AllSflowPollingEthernetsClient(AbstractResourceClient):
	def __init__(self, endpoint=None, sessionid=None, ipaddress=None, debug=False):
		if not endpoint:
			if ipaddress:
				result = urlparse(BASE_URL[0])
	...
	def submitSflowPollingEthernet(self, ethernet):
		"""
	...
	def getAllSflowPollingEthernets(self):
		"""
